...
|---|---|---|---|
| BUG-001 | P1, READY, medium developer | net48 shared result conversion exports Double 1.0000000000000002 and Single 1.00000012 as 1; use explicit round-trip precision without changing other types | Lead actual-assembly reproduction; light T14 and affected T07/T09 after correction |
| BUG-002 | P2, READY, medium developer | Hold formatting for A, open equal-text B, then release A: response modifies/marks B dirty; add logical document generation plus content/context revision guard | Lead actual-host fixture reproduction; light T15 and affected T08/document/undo checks |
